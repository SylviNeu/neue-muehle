  ...
  <footer className="bg-primary text-primary-foreground">
    <div className="container-narrow mx-auto section-padding">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm opacity-80">
            <li className="flex items-center gap-2"><MapPin className="h-4 w-4 flex-shrink-0" /> Musterstraße 1, 12345 Musterstadt</li>
            <li className="flex items-center gap-2"><Phone className="h-4 w-4 flex-shrink-0" /> +49 123 456 789</li>
            <li className="flex items-center gap-2"><Mail className="h-4 w-4 flex-shrink-0" /> info@hof-frische.de</li>
          </ul>
        </div>
      ...
      <div className="border-t border-primary-foreground/20 mt-12 pt-6 text-center text-sm opacity-60">
        © {new Date().getFullYear()} Hof Frische — Diplom-Landwirt. Alle Rechte vorbehalten.
      </div>
    </div>
  </footer>
);
