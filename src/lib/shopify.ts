...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'hof-frische-8r0hy.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = 'e5fb453902b9f2a18f74e633ebf59b16';
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify: Zahlung erforderlich", {
      description: "Dein Shopify Store benötigt ein aktives Abo. Besuche admin.shopify.com zum Upgraden.",
    });
    return;
  }
